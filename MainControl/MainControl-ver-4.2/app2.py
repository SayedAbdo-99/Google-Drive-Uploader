...
app.config['MYSQL_PASSWORD'] = 'Sayed;99'
...
def allowed_file(filename,fileSize):
    extention =filename.split('.', 1)[-1].lower()
...
def upload():
    ...
    if request.method == 'GET':
        ...
        print(file)
    fSiz=100000#round(float(len(fTest.read())))
    ...
    return jsonify({'htmlresponse': render_template('uploader/response.html', msg=msg, msg0=msg0, msg1=msg1, msg2=msg2, msg3=msg3, filenameimage=filePath)})
